var emailLabel = document.querySelector("#loginEmailLabel") || document.querySelector("#registerEmailLabel"),
    email = document.querySelector("#loginEmail") || document.querySelector("#registerEmail"),
    username = document.querySelector("#registerUsername"), // Añadido para el formulario de registro
    passwordLabel = document.querySelector("#loginPasswordLabel") || document.querySelector("#registerPasswordLabel"),
    password = document.querySelector("#loginPassword") || document.querySelector("#registerPassword"),
    confirmPassword = document.querySelector("#registerConfirmPassword"), // Añadido para el formulario de registro
